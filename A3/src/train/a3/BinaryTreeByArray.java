...
// constructor to construct blank tree
  public BinaryTreeByArray(int capacity)
  {
    if (capacity<=0){
      capacity = 1;
      System.out.println("Capacity too small, bi-tree size is set as 1 by default");
    } else if(capacity>=2147483642){
      capacity = 1;
      System.out.println("Capacity too big, bi-tree size is set as 1 by default");
    } else {
