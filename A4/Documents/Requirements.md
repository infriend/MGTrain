...
### 3.5 申请拍卖功能需求分析
&ensp;&ensp;&ensp;&ensp;客户登录系统后，可以选择发布拍卖申请，使用申请拍卖功能，成为委托人。
委托人可以新建拍卖申请，填写相关信息，等待拍卖师开始拍卖或者拒绝拍卖。委托人能够撤回拍卖申请，
让申请不再出现在拍卖师待选列表中。委托人能够查看其拍卖物的进度，查看所有历史拍卖物的列表。
...
| 参与者   | 客户                       |
| 前置条件 | 客户已经登录                 |
| 后置条件 | 拍卖师能在待审列表中看到新的信息，客户也能在申请列表中看到进度  |
| 正常流程 | 1.选择发布新的拍卖<br> 2.填入拍卖信息<br> 3.选择发布 |
| 扩展流程 | 2a.若拍卖已经处于开始状态，则返回“无法修改”的信息 |
